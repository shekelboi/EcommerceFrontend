...
export class ProductPageComponent {
    ...
    constructor(private route: ActivatedRoute, private categoryService: CategoryService, private productService: ProductService, public imageService: ImageService) {
